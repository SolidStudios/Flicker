...
public class Shader {
	...
	private void loadShader(){
		...
		try{
			BufferedReader reader = new BufferedReader(new InputStreamReader(ResourceLoader.class.getResourceAsStream("resources/" + vertexLoc)));
		...
		try{
			BufferedReader reader = new BufferedReader(new InputStreamReader(ResourceLoader.class.getResourceAsStream("resources/" + fragmentLoc)));
			String line;
			while((line = reader.readLine()) != null){
